...
#La nouvelle matrice des observations.
pca = PCA(n_components=2)
data_pca = pca.fit_transform(data)

#Affichage des valeurs propres et des vecteurs propres associés aux axes principaux.
...
#Vérification de la somme des inerties de chaque axe par rapport a la dimension de la base de données.
print("Somme des inerties : ", np.sum(pca.explained_variance_ratio_))

#Représentation des données ainsi que des centres obtenus par l’algorithme du k-means sur les deux axes principaux.
